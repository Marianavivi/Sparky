...
module.exports = {
     ...
     */
    botname: process.env.BotName || "SPARKY",
    footer: process.env.Footer || "©SPARKY",
    ...
    ownernumber: process.env.Owner_Number || "254732647560",
    instagramId: process.env.Insta || "xj_ent",

    /**
     * other details and parameters
     */
    author: process.env.Author || "Mariana",
    packname: process.env.PackName || "Sparky",
    socialLink: process.env.Web || "https://github.com/Marianavivi",
    groupLink: process.env.GcLink || "https://chat.whatsapp.com/Gp00pwuFB0wIhu4Hp688M5",
    ...
    imageUrl: "https://i.imgur.com/wa1wlgK.jpeg", // image url, to replace to your url upload your image to https://imgbb.com
    imageMentionUrl: "https://i.imgur.com/wa1wlgK.jpeg", // image for mention reply audio media
